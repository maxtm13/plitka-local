...
<?
    ...
    <div class="bx_item_container">
        ...
        <div class="bx_lt">
            ...
            <div class="info-pic">
                <div class="desc-pic" >
                    <img src="/local2/templates/new_design/components/bitrix\catalog\template1\bitrix\catalog.element\.default\Frame 7.png">
                </div>
                <div class="desc-pic">
                    <img src="/local2/templates/new_design/components/bitrix\catalog\template1\bitrix\catalog.element\.default\Frame 5.png">                </div>
                <div class="desc-pic">
                    <img src="/local2/templates/new_design/components/bitrix\catalog\template1\bitrix\catalog.element\.default\Frame 4.png">
                </div>
                <div class="desc-pic">

                    <img src="/local2/templates/new_design/components/bitrix\catalog\template1\bitrix\catalog.element\.default\Frame 8.png">
                </div>
            </div>
        </div>
        <? include 'top2.php'; ?>
